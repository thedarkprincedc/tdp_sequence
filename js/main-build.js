...
(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('backbone.marionette',['backbone', 'underscore', 'backbone.radio'], factory) :
...
;
define('js/main',['require','jquery','underscore','backbone','backbone.radio','backbone.marionette'],function (require) {
	var $ = require('jquery'),
